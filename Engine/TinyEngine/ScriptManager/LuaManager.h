...
public:
	...
	// you can push many LuaVals to stack. For example: pushVal(1, "abc", LuaVal::NIL, {1,2,3}).
	// Now lua stack is:
	// -1 : {1,2,3}
	// -2 : nil
	// -3 : "abc"
	...
	void pushVal(const LuaVal& val1, Args... args);
...
template<typename... Args>
void LuaManager::pushVal(const LuaVal& val1, Args... args)
{
	pushVal(val1);
	pushVal(args...);
}
