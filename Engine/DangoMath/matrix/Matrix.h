...
namespace DangoMath
{
	...
	public:
		...
		// Set a row
		inline void setRow(int row, const DangoMath::VectorStorage<ValueType, ColNum>& val);
    ...
    // check equal
	template <class ValueType, int RowNum, int ColNum>
	bool operator==(const DangoMath::MatrixStorage<ValueType, RowNum, ColNum>& left, const DangoMath::MatrixStorage<ValueType, RowNum, ColNum>& right);

	// dot
	template <class ValueType, int RowNum_left, int ColNum_left, int RowNum_right, int ColNum_right>
	DangoMath::MatrixStorage<ValueType, RowNum_left, ColNum_right> operator*(const DangoMath::MatrixStorage<ValueType, RowNum_left, ColNum_left>& left,
