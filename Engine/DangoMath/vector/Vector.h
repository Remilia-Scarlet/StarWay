#pragma once
#include "DangoMath/quaternion/Quaternion.h"
...
namespace DangoMath
{
	...
	//////////////////////////////////////////////////////////////////////////
	template <class ValueType, int Size>
	bool operator==(const DangoMath::VectorStorage<ValueType, Size>& left, const DangoMath::VectorStorage<ValueType, Size>& right);

	// dot
	template <class ValueType, int Size>
	ValueType operator*(const DangoMath::VectorStorage<ValueType, Size>& left, const DangoMath::VectorStorage<ValueType, Size>& right);

	// scale
	template <class ValueType, int Size>
	DangoMath::VectorStorage<ValueType, Size> operator*(const DangoMath::VectorStorage<ValueType, Size>& vec, const ValueType& scale);
	template <class ValueType, int Size>
	DangoMath::VectorStorage<ValueType, Size> operator*(const ValueType& scale, const DangoMath::VectorStorage<ValueType, Size>& vec);
	template <class ValueType, int Size>
	DangoMath::VectorStorage<ValueType, Size> operator/(const DangoMath::VectorStorage<ValueType, Size>& vec, const ValueType& scale);
	template <class ValueType, int Size>
	DangoMath::VectorStorage<ValueType, Size> operator/(const ValueType& scale, const DangoMath::VectorStorage<ValueType, Size>& vec);
	...
	// plus
	template <class ValueType, int Size>
	DangoMath::VectorStorage<ValueType, Size> operator+(const DangoMath::VectorStorage<ValueType, Size>& vec1, const DangoMath::VectorStorage<ValueType, Size>& vec2);
