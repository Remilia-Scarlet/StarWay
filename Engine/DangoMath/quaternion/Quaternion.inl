...
bool DangoMath::operator==(const DangoMath::QuaternionStorage<ValueType>& a, const DangoMath::QuaternionStorage<ValueType>& b)
{
	return a.equal(b);
}

template<class ValueType>
DangoMath::QuaternionStorage<ValueType> DangoMath::operator*(const DangoMath::QuaternionStorage<ValueType>& a, const DangoMath::QuaternionStorage<ValueType>& b)
{
	return a.product(b);
}
//////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////
template <class ValueType>
DangoMath::QuaternionStorage<ValueType>::QuaternionStorage()
{
	reset();
}

template <class ValueType>
DangoMath::QuaternionStorage<ValueType>::QuaternionStorage(const VectorStorage<ValueType, 3>& eulerAngles)
{
	reset(eulerAngles);
}

template <class ValueType>
DangoMath::QuaternionStorage<ValueType>::QuaternionStorage(const ValueType& xRotate, const ValueType& yRotate, const ValueType& zRotate)
{
	reset(xRotate, yRotate, zRotate);
}

template <class ValueType>
DangoMath::QuaternionStorage<ValueType>::QuaternionStorage(const VectorStorage<ValueType, 3>& axis, const ValueType& angle)
{
	reset(axis, angle);
}

template <class ValueType>
DangoMath::QuaternionStorage<ValueType>::QuaternionStorage(const VectorStorage<ValueType, 3>& from, const VectorStorage<ValueType, 3>& to)
{
	reset(from, to);
}

template <class ValueType>
DangoMath::QuaternionStorage<ValueType>::QuaternionStorage(const MatrixStorage<ValueType, 4, 4>& rotationMatrix)
{
	reset(rotationMatrix);
}

template <class ValueType>
DangoMath::QuaternionStorage<ValueType>::QuaternionStorage(const ValueType& w, const ValueType& x, const ValueType& y, const ValueType& z)
{
	reset(w, x, y, z);
}

template <class ValueType>
DangoMath::QuaternionStorage<ValueType>::QuaternionStorage(const QuaternionStorage& other)
{
	reset(other);
}
...
template <class ValueType>
void DangoMath::QuaternionStorage<ValueType>::reset()
{
	_w = 1;
	_x = 0;
	_y = 0;
...
template <class ValueType>
void DangoMath::QuaternionStorage<ValueType>::reset(const VectorStorage<ValueType,3>& eulerAngles)
{
	reset(eulerAngles.X(), eulerAngles.Y(), eulerAngles.Z());
}

template <class ValueType>
void DangoMath::QuaternionStorage<ValueType>::reset(const ValueType& xRotate, const ValueType& yRotate, const ValueType& zRotate)
{
...
template <class ValueType>
void DangoMath::QuaternionStorage<ValueType>::reset(const VectorStorage<ValueType, 3>& axis, const ValueType& angle)
{
...
template <class ValueType>
void DangoMath::QuaternionStorage<ValueType>::reset(const VectorStorage<ValueType, 3>& from, const VectorStorage<ValueType, 3>& to)
{
...
template <class ValueType>
void DangoMath::QuaternionStorage<ValueType>::reset(const MatrixStorage<ValueType, 4, 4>& rotationMatrix)
{
...
template <class ValueType>
void DangoMath::QuaternionStorage<ValueType>::reset(const ValueType& w, const ValueType& x, const ValueType& y, const ValueType& z)
{
	_w = w;
	_x = x;
	_y = y;
...
template <class ValueType>
void DangoMath::QuaternionStorage<ValueType>::reset(const QuaternionStorage& other)
{
	reset(other.W(), other.X(), other.Y(), other.Z());
}

template <class ValueType>
ValueType& DangoMath::QuaternionStorage<ValueType>::operator()(int index)
{
	switch (index)
	{
	case 0:
...
template <class ValueType>
const ValueType& DangoMath::QuaternionStorage<ValueType>::operator()(int index) const
{
	return const_cast<QuaternionStorage<ValueType>&>(*this)(index);
}

template <class ValueType>
DangoMath::QuaternionStorage<ValueType>& DangoMath::QuaternionStorage<ValueType>::operator=(const QuaternionStorage& other)
{
	reset(other);
	return *this;
}
...
template <class ValueType>
ValueType& DangoMath::QuaternionStorage<ValueType>::W()
{
	return _w;
}

template <class ValueType>
const ValueType& DangoMath::QuaternionStorage<ValueType>::W() const
{
	return _w;
}

template <class ValueType>
ValueType& DangoMath::QuaternionStorage<ValueType>::X()
{
	return _x;
}

template <class ValueType>
const ValueType& DangoMath::QuaternionStorage<ValueType>::X() const
{
	return _x;
}

template <class ValueType>
ValueType& DangoMath::QuaternionStorage<ValueType>::Y()
{
	return _y;
}

template <class ValueType>
const ValueType& DangoMath::QuaternionStorage<ValueType>::Y() const
{
	return _y;
}

template <class ValueType>
ValueType& DangoMath::QuaternionStorage<ValueType>::Z()
{
	return _z;
}

template <class ValueType>
const ValueType& DangoMath::QuaternionStorage<ValueType>::Z() const
{
	return _z;
}

template <class ValueType>
DangoMath::QuaternionStorage<ValueType> DangoMath::QuaternionStorage<ValueType>::normalized() const
{
...
template <class ValueType>
DangoMath::QuaternionStorage<ValueType>& DangoMath::QuaternionStorage<ValueType>::normalizeInPlace()
{
...
template <class ValueType>
bool DangoMath::QuaternionStorage<ValueType>::isNormalized() const
{
	return isEqual(_x*_x + _y*_y + _z*_z + _w*_w, (ValueType)1);
}

template <class ValueType>
DangoMath::MatrixStorage<ValueType, 4, 4> DangoMath::QuaternionStorage<ValueType>::toRotationMatrix() const
{
...
template <class ValueType>
DangoMath::VectorStorage<ValueType, 3> DangoMath::QuaternionStorage<ValueType>::toEularAngle() const
{
...
template <class ValueType>
std::pair<DangoMath::VectorStorage<ValueType, 3>, ValueType> DangoMath::QuaternionStorage<ValueType>::toAxisAngle() const
{
...
template <class ValueType>
DangoMath::QuaternionStorage<ValueType> DangoMath::QuaternionStorage<ValueType>::conjugate() const
{
...
template <class ValueType>
DangoMath::QuaternionStorage<ValueType>& DangoMath::QuaternionStorage<ValueType>::conjugateInPlace()
{
	_x = -_x;
	_y = -_y;
	_z = -_z;
...
template <class ValueType>
DangoMath::QuaternionStorage<ValueType> DangoMath::QuaternionStorage<ValueType>::product(const QuaternionStorage<ValueType>& other) const
{
...
template <class ValueType>
DangoMath::QuaternionStorage<ValueType>& DangoMath::QuaternionStorage<ValueType>::productInPlace(const QuaternionStorage<ValueType>& other)
{
	*this = product(other);
	return *this;
}
...
template <class ValueType>
bool DangoMath::QuaternionStorage<ValueType>::equal(const QuaternionStorage<ValueType>& other) const
{
